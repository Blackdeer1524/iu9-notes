...
\end{aligned}$$
Введем классификацию уравнений в точке $M_0(x_0, y_0): a_{12}^2 - a_{11}a_{22} = \Delta$
...
## 4.1. Уравнение гиперболического типа
...
## 4.2. Уравнение элиптического типа
...
## 4.3. Уравнения параболического типа
