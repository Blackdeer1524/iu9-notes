...
**Лемма**
Пусть $U_1(x), U_2(x)$ - 2 ЛНЗ решения уравнения $(1)$, удовлетворяющие условиям $(a)$ и $(b)$, тогда если $U_1(x)$ ограничена, ищеет ... предел в точке $x=a$, то решение $U_2$ в точке $a$ неограничено.
Причем, если $U_1(a)\neq 0$, то $U_2(x)$ имеет в точке $x=a$ логарифмическую особенность, и если $U_1(x)$ имеет в точке a нуль $\nu$-го порядка, то $U_2(x)$ имеет в точке $x=a$ полюс $\nu$-го порядка. 
